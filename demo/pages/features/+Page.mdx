import { Link, Warning, Construction, Danger, NoteWithoutIcon, NoteWithCustomIcon, ReadingRecommendation, RemovedFile } from '@brillout/docpress'
...
Removed file using `<RemovedFile>` wrapper:
